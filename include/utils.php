...
/**
 * Builds a URL for use with CRM, to make it easier to create consistent URLs.
 * One of the parameters must be provided or the function with throw an
 * exception. `null` values are ignored.
 *
 * @param string|null $module
 * @param string|null $action
 * @param string|null $return_module
 * @param string|null $return_action
 * @return string The string returned will be a SuiteCRM URL in the format 'index.php?module=Foo&action=bar', depending on what is provided to the function.
 */
function buildSuiteUrl($module = null, $action = null, $return_module = null, $return_action = null) {
    $urlParts = [];
